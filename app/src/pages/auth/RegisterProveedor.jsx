...
const CATEGORIAS = [
  { value: 'banquete', label: 'Banquete / Catering' },
  { value: 'fotografia', label: 'Fotografía y video' },
  { value: 'musica', label: 'Música / DJ' },
  { value: 'decoracion', label: 'Decoración y flores' },
  { value: 'locacion', label: 'Locación / Salón' },
  { value: 'mobiliario', label: 'Mobiliario y equipo' },
  { value: 'animacion', label: 'Animación / Espectáculos' },
...
export default function RegisterProveedor() {
  ...
  return (
    <AuthLayout
      title={'Más eventos,\nmenos esfuerzo.'}
      subtitle="Crea tu perfil de proveedor y empieza a recibir solicitudes de organizadores."
      bullets={[
        'Recibe solicitudes calificadas de organizadores',
        'Envía cotizaciones y cierra tratos en un lugar',
    ...
    >
      ...
      <h2 className="text-2xl font-semibold tracking-tight text-ink-strong">Crear cuenta · Proveedor</h2>
      <p className="mt-1.5 text-sm text-ink-muted">Empieza gratis y mejora tu plan cuando quieras.</p>

      <form onSubmit={handleSubmit} className="mt-7 space-y-4">
        <Input label="Nombre de contacto" name="nombre" placeholder="Marco Reyes" required />
        <Input label="Nombre del negocio" name="negocio" placeholder="Estudio Reyes Fotografía" required />
        <Select
